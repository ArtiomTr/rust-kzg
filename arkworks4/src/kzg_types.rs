...
use ark_ec::{models::short_weierstrass::Projective, AffineRepr, Group as ArkGroup};
...
impl kzg::TorsionSubgroup for ArkG2 {
    fn generator() -> Self {
        G2_GENERATOR
    }
