...
mod tests {
    ...
    fn test_reduce_partials_() {
        test_reduce_partials::<ArkFr, LFFTSettings, PolyData>();
    }

    #[test]
    fn reduce_partials_random_() {
        reduce_partials_random::<ArkFr, LFFTSettings, PolyData>();
    }

    #[test]
    fn check_test_data_() {
        check_test_data::<ArkFr, LFFTSettings, PolyData>();
    }

    #[test]
    fn zero_poly_known_() {
        zero_poly_known::<ArkFr, LFFTSettings, PolyData>();
    }

    #[test]
    fn zero_poly_random_() {
        zero_poly_random::<ArkFr, LFFTSettings, PolyData>();
    }

    #[test]
    fn zero_poly_all_but_one_() {
        zero_poly_all_but_one::<ArkFr, LFFTSettings, PolyData>();
    }

    #[test]
    fn zero_poly_252_() {
        zero_poly_252::<ArkFr, LFFTSettings, PolyData>();
    }
}
